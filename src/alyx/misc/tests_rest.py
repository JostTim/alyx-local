...
class APIActionsTests(BaseTests):
    ...
    def test_create_lab_membership(self):
        ...
        lm = LabMembership.objects.create(
            user=self.superuser,
...
class TestCacheView(BaseTests):
    ...
    def test_get_cache_info(self):
        ...
        URL = "s3://" + path
        with (
            mock.patch("misc.views.TABLES_ROOT", URL),
        ...
        # Test URI validation
        with mock.patch("misc.views.TABLES_ROOT", "fs://path/to/cache"), self.assertRaises(ValueError):
            _get_cache_info()
