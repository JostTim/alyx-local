...
class CageType(BaseModel):
    description = models.CharField(
        max_length=1023,
        blank=True,
        help_text="Extended description of the cage product/brand",
    )
...
class Enrichment(BaseModel):
    ...
    description = models.CharField(
        max_length=1023,
        blank=True,
        help_text="Extended description of the enrichment, link ...",
    )
...
class Food(BaseModel):
    ...
    description = models.CharField(
        max_length=1023,
        blank=True,
        help_text="Extended description of the food, link ...",
    )
