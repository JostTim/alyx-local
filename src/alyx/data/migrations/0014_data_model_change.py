...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                default="__undefined",
                help_text="object (first part of the name) as per alf convention described here : "
            ...
            field=models.CharField(
                ...
                validators=[
                    django.core.validators.RegexValidator(
                        "(?P<object>.*)\\.(?P<attribute>.*)\\.(?P<extension>.*)",
                        code="invalid_alf",
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                help_text="relative root path to the repository on the server, without the hostname. "
                "e.g. /lab/data/Adaptation",
                max_length=1000,
            ),
        ),
        migrations.AlterField(
