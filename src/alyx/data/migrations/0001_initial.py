...
def create_default_data_format(apps, schema_editor):
    DataFormat = apps.get_model("data", "DataFormat")
    DataFormat.objects.get_or_create(name="unknown")


def create_default_dataset_type(apps, schema_editor):
    DatasetType = apps.get_model("data", "DatasetType")
    DatasetType.objects.get_or_create(name="unknown")
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(blank=True, help_text="Name of MATLAB loader function'.", max_length=255),
                ),
                (
                    "python_loader_function",
                    models.CharField(blank=True, help_text="Name of Python loader function'.", max_length=255),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "data_url",
                    models.URLField(
                        blank=True, help_text="URL of the data repository, if it is accessible via HTTP", null=True
                    ),
                ),
                (
                    "timezone",
                ...
                (
                    "globus_endpoint_id",
                    models.UUIDField(blank=True, help_text="UUID of the globus endpoint", null=True),
                ),
                (
                    "globus_is_personal",
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, default=django.utils.timezone.now, help_text="The creation datetime.", null=True
                    ),
                ),
                (
                    "generating_software",
                    models.CharField(blank=True, help_text="e.g. 'ChoiceWorld 0.8.3'", max_length=255),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        blank=True, help_text="Short identifying nickname, e.g. 'spikes'", max_length=255, unique=True
                    ),
                ),
                (
                    "description",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                "^[a-zA-Z0-9\\_][^\\\\\\:]+$", code="invalid_path", message="Invalid path"
                            )
                        ],
                    ),
                ),
                (
                    "exists",
                    models.BooleanField(default=False, help_text="Whether the file exists in the data repository"),
                ),
                (
                    "data_repository",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="data.DataRepository"),
                ),
                (
                    "dataset",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="file_records", to="data.Dataset"
                    ),
                ),
            ],
            options={
        ...
        migrations.RunPython(create_default_data_format, reverse_code=migrations.RunPython.noop),
        migrations.RunPython(create_default_dataset_type, reverse_code=migrations.RunPython.noop),
    ]
