    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("no-send", "do not send"), ("to-send", "to send"), ("sent", "sent")],
                        default="to-send",
                        max_length=16,
                    ),
                ),
                (
                    "subject",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="subjects.Subject"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "subjects_scope",
                    models.CharField(
                        choices=[("none", "none"), ("all", "all"), ("mine", "mine"), ("lab", "lab")], max_length=16
                    ),
                ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True, choices=[("a", "Acute"), ("r", "Recovery"), ("n", "Non-recovery")], max_length=1
            ),
        ),
