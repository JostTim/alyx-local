...
from alyx.subjects.models import ZygosityFinder, ZygosityRule, Subject, Line, Allele, Sequence, ZYGOSITY_SYMBOLS
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("subjects", nargs="*", help="Subject nicknames")
    ...
    def handle(self, *args, **options):
        ...
        if options.get("migrate_rules"):
            from alyx.subjects.zygosities import ZYGOSITY_RULES
            ...
            for l, a, rules in ZYGOSITY_RULES:
                for rule in rules:
                    ...
                    if n >= 2:
                        ...
                        res1 = r[seq1]
                        kwargs.update(
                            dict(sequence1=Sequence.objects.get_or_create(name=seq1)[0], sequence1_result=res1)
                        )
                    try:
