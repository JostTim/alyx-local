    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "probe_model",
                    models.CharField(
                        help_text="manufacturer's part number e.g. A4x8-5mm-100-20", max_length=255, unique=True
                    ),
                ),
                (
                    "description",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "x",
                    models.FloatField(
                        help_text="brain surface medio-lateral coordinate "
                        "(um) of the insertion, right +, relative to Bregma",
                        null=True,
                ...
                (
                    "y",
                    models.FloatField(
                        help_text="brain surface antero-posterior coordinate (um) of the insertion"
                        ", front +, relative to Bregma",
                        null=True,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="experiments.ProbeModel"
            ),
        ),
        migrations.AddField(
            model_name="probeinsertion",
            name="session",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="actions.EphysSession"
            ),
        ),
        migrations.AddConstraint(
            model_name="trajectoryestimate",
            constraint=models.UniqueConstraint(
                fields=("provenance", "probe_insertion"), name="unique_trajectory_per_provenance"
            ),
        ),
        migrations.AddConstraint(
            model_name="probeinsertion",
            constraint=models.UniqueConstraint(
                fields=("name", "session"), name="unique_probe_insertion_name_per_session"
            ),
        ),
    ]
