...
latex_documents = [
    (master_doc, "Alyx.tex", "Alyx Documentation", "C Rossant, M Hunter, O Winter, C Burgess, K Harris", "manual"),
]
...
man_pages = [(master_doc, "alyx", "Alyx Documentation", [author], 1)]
...
texinfo_documents = [
    (master_doc, "Alyx", "Alyx Documentation", author, "Alyx", "One line description of project.", "Miscellaneous"),
]
